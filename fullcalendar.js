...
defaults.buttonText.year = 'Y';
defaults.titleFormat.year = 'yyyy';
//defaults.agendaDisType = true;
		...
		for (m=firstMonth; m<lastMonth; m++) {
			...
			s +='<table class="fc-border-separate fc-year-month" style="width:100%;" cellspacing="0">'+
				...
				'<tr><td colspan="7" class="fc-year-monthly-header" />' +
					...
					'<div data-year="'+y+'" data-month="'+(m%12)+'">' +
			...
			for (i=0; i<6; i++) {
				...
				for (j=0; j<colCnt; j++) {
					...
					'<div class="fc-year-day fc-year-day-container">' +
						...
						'<div class="fc-day-content fc-year-day" style="min-height:'+yearCellMinH+'px;">' +
...
function View(element, calendar, viewName) {
	...
	function eventDrop(e, event, dayDelta, minuteDelta, allDay, ev, ui) {
		...
		console.log(event);
		if (!event.initiallyRepeating) moveEvents(eventsByID[eventId], dayDelta, minuteDelta, allDay);
		trigger(
			'eventDrop',
			e,
			event,
